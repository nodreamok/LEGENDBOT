...
`git clone https://github.com/nodreamok/LEGENDUSERBOT.git`
- Open Cloned Folder.
...
Poject [LEGENDBOT](https://github.com/nodreamok/LEGENDBOT) is free software: you can redistribute it and/or modify
